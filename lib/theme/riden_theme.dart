...
//
//  Usage:
//    1. Place this file in: lib/theme/riden_theme.dart
//    2. Import this file wherever needed
//    3. Use RidenColors.xxx for individual color values
//    4. Drop RidenDarkBackground() inside any Stack as the
...
abstract class RidenColors {
  ...
  /// Light gray text - secondary text color
  static const Color textSecondary = Color(0xFFBDBDBD);

  /// Hint gray text - placeholder/hint text color
  ...
  /// Glass border - subtle border for glass effect
...
class _DarkGradientPainter extends CustomPainter {
  ...
  /// Uses [alpha] 0-255 to create smooth gradient transitions.
  void _blob(
    Canvas canvas, {
